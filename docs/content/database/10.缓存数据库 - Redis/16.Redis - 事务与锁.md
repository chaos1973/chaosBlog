...
![image-20211226170941580](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226170944.png)
...
- 组队中某个命令出现了报告错误（multi 中），执行时整个的所有队列都会被取消
    ...
    ![image-20211226171839361](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226171840.png)

- 如果执行阶段（exec）某个命令报出了错误，则只有报错的命令不会被执行，而其他的命令都会执行，不会回滚

    ![image-20211226171906051](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226172102.png)



### 案例图

![image-20210408101936847](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226171736.png)

放弃事务

![image-20210408101955501](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226171704.png)

若在事务队列中存在命令性错误（类似于 Java 编译性错误），则执行 EXEC 命令时，所有命令都不会执行

![image-20210408102023204](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226171748.png)

若在事务队列中存在语法性错误（类似于 Java 的 1/0 的运行时异常），则执行 EXEC 命令时，其他正确命令会被执行，错误命令抛出异常。

![image-20210408102051072](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226171708.png)
...
![image-20211226172110847](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226172111.png)
...
![image-20211226172952960](https://cdn.staticaly.com/gh/Kele-Bingtang/static@master/img/Redis/20211226172953.png)
